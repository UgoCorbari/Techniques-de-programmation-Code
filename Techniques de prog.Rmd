...
Resum.match <- function(compet, Stade, T.away, T.home, result, spec, but_events, formation_home, formation_away, Away.data, liste_buteurs,liste_passeurs,liste_clubs,liste_minutes,clubs,clubs.but) {
  resume = paste(
    ...
    "s'est déroulé à", Stade, ", devant une foule de", spectateurs, "spectateurs. Ce match s'est soldé sur le score de", result, ".",
...
extract_match_data <- function(match_url) {
  ...
  # Extraction des informations principales (encadré 1)
  ...
  # Extraction des événements du match (encadré 3)
  ...
  # Ajustement des vecteurs pour correspondre à la longueur maximale
  ...
  # Organisation des données des évènements
  ...
  # Création d'une liste avec les informations principales et les événements
  match_summary <- list(
...
# Affichage d'un tableau propre avec les statistiques
