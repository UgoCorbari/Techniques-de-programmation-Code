...
```{r}
# Vérifiez que formation_home et formation_away sont bien définis avant l'appel
formations <- extraire_formation(page)  # Extrait les formations à partir de la page

# Initialisez les variables formation_home et formation_away
...
Generation_de_resumes <- function(urlpage, user_agent) {
  ...
  resume <- Resum.match(
    ...
    T.away = details$away_team,
    T.home = details$home_team,
