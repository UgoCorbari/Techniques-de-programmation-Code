...
-   **Objectifs principaux :**
    - Développer un programme générant des **résumés de matchs de football**.
    - Automatiser la récupération, l'analyse, et la structuration des données pour produire un résumé narratif détaillé, automatisé et réutilisable
-   **Motivations :**
    -   Pratiquer des techniques de programmation, notamment le web scraping
    -   Le football : une passion commune
...
-   **Structure de la page web ciblée.**
    ...
    -   Encadré 3 : Données liées aux buts marqués pendant le match, nom du buteur, nom du passeur décisif, la minute à laquelle chaque but a été inscrit.
...
```{r echo=FALSE}
resume <- "Dans le cadre de la compétition Championnat National 3 - Groupe H , le match opposant Racing Strasbourg B à Jura Dolois Football s'est déroulé à Parc des Sports , devant une foule de 48 spect. spectateurs. Ce match s'est soldé sur le score de 1:1(1:1) . L'équipe de Racing Strasbourg B s'est présentée en Racing Strasbourg B , tandis que les hommes de Jura Dolois Football étaient disposés en Jura Dolois Football . Au cours des 90 minutes, les deux équipes ont donné le meilleur d'elles-mêmes, mais aucune d'elles n'a su se départager. Ce match se solde sur un score nul qui n'arrange personne.
...
resume_parts <- data.frame(
  ...
  "Détails" = c(
    "Dans le cadre de la compétition Championnat National 3 - Groupe H , le match opposant Racing Strasbourg B à Jura Dolois Football s'est déroulé à Parc des Sports , devant une foule de 48 spect. spectateurs. Ce match s'est soldé sur le score de 1:1(1:1) .",
    "L'équipe de Racing Strasbourg B s'est présentée en Racing Strasbourg B , tandis que les hommes de Jura Dolois Football étaient disposés en Jura Dolois Football . Au cours des 90 minutes, les deux équipes ont donné le meilleur d'elles-mêmes, mais aucune d'elles n'a su se départager. Ce match se solde sur un score nul qui n'arrange personne.",
    "Ce match nous à offert 90 minutes de divertissements et nous avons hâte de suivre ces deux équipes pour la suite de la saison.."
  )
)
...
-   **Des limites :**
    - Changement de la structure des pages HTML
    - Données manquantes ou imprécises
    - Limites techniques, conceptuelles et naturelles
